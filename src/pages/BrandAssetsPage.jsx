...
export default function BrandAssetsPage() {
  ...
  const { assets, setAssets, loading, error } = useAssets({ category: "brand-assets", search: search || undefined });
    ...
    <div>
      <div className="flex items-center justify-between">
        <div>
          ...
          <p className="mt-1 text-sm text-gray-500">Logos, fonts, color palettes, and other brand materials.</p>
        </div>
        {isAdmin && (
      ...
      <div className="mt-6"><SearchBar value={search} onChange={setSearch} /></div>
      <div className="mt-6">
      ...
      <UploadAssetModal isOpen={uploadOpen} onClose={() => setUploadOpen(false)} defaultCategory="brand-assets" onAssetAdded={(asset) => setAssets((prev) => [asset, ...prev])} />
